...
export class Authorizer {
  ...
  #client
  #domainBlocker
  constructor (actorStorage, formatter, client, domainBlocker) {
  ...
  async canRead (actor, object) {
    ...
    if (await this.#domainBlocker.isBlockedObject(object)) {
      return false
    }
  ...
  async #canReadLocal (actor, object) {
    ...
    if (await this.#domainBlocker.isBlocked(actor.id)) {
      return false
    }
